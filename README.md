...
## Технологии
   - Java 17 (можно скачать по ссылке: https://adoptium.net/temurin/releases/?version=17)
   - Gradle (можно скачать по ссылке: https://gradle.org/install/)
   - JUnit 5
...
Далее откройте файл и запишите следующие параметры (укажите нужный вам порт, а также параметр видимости):
    ...
    ### Интервал обновления экрана (целое число - количество секунд)
    monitoring.interval.seconds = 3
